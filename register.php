...
<body>
<div class="container" style="width: 400px; margin-top: 5%; position: static; background-color: #e8ead3; box-shadow: 5px 7px 7px 10px #888888; border-radius: 1px solid black;">
    <div class="wrapper">
        <h2 style="text-align: center;">Registrasi User</h2><br/>
