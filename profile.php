...
<div class="container">
    <div class="row profile" style="margin-left: -170px;">
		<div class="col-md-3">
			<div class="profile-sidebar">
				...
				<div class="profile-userpic">
					<img src="login.png" class="img-responsive" style="width: 60%; height: 21%; margin: 0 auto;">				
				</div>
				<!-- END SIDEBAR USERPIC -->
		...
		<div class="col-md-9">
            <div class="profile-content" style="padding: 20px; background: #ffffff; height: 600px; width: 1130px;">
